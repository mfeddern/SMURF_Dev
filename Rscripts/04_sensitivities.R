...
# AUTHORS:    KIVA OKEN & MEGAN FEDDERN

# WHAT DOES THIS SCRIPT DO?
#   (1) MODIFIES SS FILES TO RUN INDEX SENSITIVITES
#   (2) RUNS SENSITIVITIES OF PRE-RECRUIT INDICES
#   (3) PLOTS SENSITIVITES OUTPUTS
#   (4) EXPORTS PLOTS AND .CSVS FOR TABLES
#   (5) COMPARES CORRELATION ACROSS PRE-RECRUIT INDICES
#
#   INITIAL CODE WAS DEVELOPED BY K. OKEN BUT WAS 
#   SUBSTANTIALLY MODIFIED BY M. FEDDERN FOR THIS 
#   APPLICATION
#
